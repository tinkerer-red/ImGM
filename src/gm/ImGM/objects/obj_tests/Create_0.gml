/// @description Manual Testings object
...
test_1_show_image_button_grid = function() {
    var _x_offset = obj_control.imgm.base_x + room_width/4;
    var _y_offset = obj_control.imgm.base_y + room_height/4;
    ImGui.SetNextWindowPos(_x_offset, _y_offset, ImGuiCond.Appearing);
    ...
    if (ImGui.Begin("Test 1: Button Sprites Grid")) {
